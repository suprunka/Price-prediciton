...
def connect():
    connection = MongoClient("mongodb://drugi:90809988Qwe@prediction-shard-00-00-jm5ad.mongodb.net:27017,prediction"
                             "-shard-00-01-jm5ad.mongodb.net:27017,prediction-shard-00-02-jm5ad.mongodb.net:27017/te"
                             "st?ssl=true&replicaSet=Prediction-shard-0&authSource=admin&retryWrites=true")
